                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handelSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='tel' id='telnum' name='telnum' placeholder='Contact Tel.' value={this.state.telnum} onChange={this.handelInputChange} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                                <Label htmlFor='email' md={2}>Email</Label>
                                <Col md={10}>
                                    <Input type='tel' id='email' name='email' placeholder='Email' value={this.state.email} onChange={this.handelInputChange} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='textarea' id='message' row='20' name='message' value={this.state.message} onChange={this.handelInputChange} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
